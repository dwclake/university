...
class Array {
  ...
  public:
    ...
    int copies() const { return this->_copies; }
    ...
    // Adds value to the end of the array, doubling capacity when more space is needed
...
// Add a new element to the end of the array
template <class T>
void Array<T>::insert_d(const T& value) {
  // Copy array and size
  int old_size = this->_size;
